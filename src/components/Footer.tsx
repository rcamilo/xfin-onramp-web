    ...
    <footer className="border-t border-ink-200 bg-white pt-14 pb-16 text-ink-500 text-xs">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-ink-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Link href="/" className="text-xl font-black tracking-[-0.03em] text-ink-900 hover:opacity-90 transition">
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-ink-500">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 font-medium text-ink-600">
            <Link href="/termos" className="hover:text-brand transition">
              Termos de Uso
            </Link>
            <span>·</span>
            <Link href="/privacidade" className="hover:text-brand transition">
              Privacidade & LGPD
            </Link>
            <span>·</span>
            <Link href="/compliance" className="hover:text-brand transition">
              Compliance BACEN
            </Link>
            <span>·</span>
            <a 
